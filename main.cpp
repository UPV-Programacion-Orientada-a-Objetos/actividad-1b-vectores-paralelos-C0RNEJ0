...
const int INICIA_PRODUCTOS = 5; // cantidad inicial cargada

//  ARREGLOS PARALELOS 
// Mismo índice = mismo producto
int    codigos[MAX_PRODUCTOS]   = {101, 102, 103, 104, 105};
...
int    stocks[MAX_PRODUCTOS]    = {50, 120, 75, 45, 10};
float  precios[MAX_PRODUCTOS]   = {15.50f, 8.75f, 20.00f, 25.99f, 120.00f};
